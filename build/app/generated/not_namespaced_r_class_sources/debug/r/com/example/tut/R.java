...
public final class R {
  ...
  public static final class styleable {
     ...
     * <tr><td><code>{@link #ActivityFilter_activityAction com.example.tut:activityAction}</code></td><td>Action used for activity launch.</td></tr>
     * <tr><td><code>{@link #ActivityFilter_activityName com.example.tut:activityName}</code></td><td>Component name of the primary activity in the split.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.tut:activityAction
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.tut:activityName
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #ActivityRule_alwaysExpand com.example.tut:alwaysExpand}</code></td><td>Whether the activity should always be expanded on launch.</td></tr>
     * </table>
     ...
     * "<code>false</code>".
     *
     * @attr name com.example.tut:alwaysExpand
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #Capability_queryPatterns com.example.tut:queryPatterns}</code></td><td>Resource reference to the string array of query patterns for a custom capability.</td></tr>
     * <tr><td><code>{@link #Capability_shortcutMatchRequired com.example.tut:shortcutMatchRequired}</code></td><td>Indicates whether a parameter in a capability template can only contain a matched
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name com.example.tut:queryPatterns
     */
     ...
     * "<code>false</code>".
     *
     * @attr name com.example.tut:shortcutMatchRequired
     */
     ...
     * <tr><td><code>{@link #ColorStateListItem_alpha com.example.tut:alpha}</code></td><td>Alpha multiplier applied to the base color.</td></tr>
     * </table>
     ...
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name com.example.tut:alpha
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderAuthority com.example.tut:fontProviderAuthority}</code></td><td>The authority of the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderCerts com.example.tut:fontProviderCerts}</code></td><td>The sets of hashes for the certificates the provider should be signed with.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchStrategy com.example.tut:fontProviderFetchStrategy}</code></td><td>The strategy to be used when fetching font data from a font provider in XML layouts.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchTimeout com.example.tut:fontProviderFetchTimeout}</code></td><td>The length of the timeout during fetching.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderPackage com.example.tut:fontProviderPackage}</code></td><td>The package for the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderQuery com.example.tut:fontProviderQuery}</code></td><td>The query to be sent over to the provider.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderSystemFontFamily com.example.tut:fontProviderSystemFontFamily}</code></td><td>Provides the system font family name to check before downloading the font.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.tut:fontProviderAuthority
     */
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name com.example.tut:fontProviderCerts
     */
     ...
     * </table>
     *
     * @attr name com.example.tut:fontProviderFetchStrategy
     */
     ...
     * </table>
     *
     * @attr name com.example.tut:fontProviderFetchTimeout
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.tut:fontProviderPackage
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.tut:fontProviderQuery
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.tut:fontProviderSystemFontFamily
     */
     ...
     * <tr><td><code>{@link #FontFamilyFont_font com.example.tut:font}</code></td><td>The reference to the font file to be used.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontStyle com.example.tut:fontStyle}</code></td><td>The style of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontVariationSettings com.example.tut:fontVariationSettings}</code></td><td>The variation settings to be applied to the font.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontWeight com.example.tut:fontWeight}</code></td><td>The weight of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_ttcIndex com.example.tut:ttcIndex}</code></td><td>The index of the font in the tcc font file.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name com.example.tut:font
     */
     ...
     * </table>
     *
     * @attr name com.example.tut:fontStyle
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.tut:fontVariationSettings
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name com.example.tut:fontWeight
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name com.example.tut:ttcIndex
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #SplitPairFilter_primaryActivityName com.example.tut:primaryActivityName}</code></td><td>Component name of the primary activity in the split.</td></tr>
     * <tr><td><code>{@link #SplitPairFilter_secondaryActivityAction com.example.tut:secondaryActivityAction}</code></td><td>Action used for secondary activity launch.</td></tr>
     * <tr><td><code>{@link #SplitPairFilter_secondaryActivityName com.example.tut:secondaryActivityName}</code></td><td>Component name of the secondary activity in the split.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.tut:primaryActivityName
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.tut:secondaryActivityAction
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.tut:secondaryActivityName
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #SplitPairRule_clearTop com.example.tut:clearTop}</code></td><td>If there is an existing split with the same primary container, indicates whether the
     * existing secondary container on top and all activities in it should be destroyed when a new
     * split is created using this rule.</td></tr>
     * <tr><td><code>{@link #SplitPairRule_finishPrimaryWithSecondary com.example.tut:finishPrimaryWithSecondary}</code></td><td>When all activities are finished in the secondary container, the activity in the
     * primary container that created the split should also be finished.</td></tr>
     * <tr><td><code>{@link #SplitPairRule_finishSecondaryWithPrimary com.example.tut:finishSecondaryWithPrimary}</code></td><td>When all activities are finished in the primary container, the activities in the
     * secondary container in the split should also be finished.</td></tr>
     * <tr><td><code>{@link #SplitPairRule_splitLayoutDirection com.example.tut:splitLayoutDirection}</code></td><td></td></tr>
     * <tr><td><code>{@link #SplitPairRule_splitMinSmallestWidth com.example.tut:splitMinSmallestWidth}</code></td><td></td></tr>
     * <tr><td><code>{@link #SplitPairRule_splitMinWidth com.example.tut:splitMinWidth}</code></td><td></td></tr>
     * <tr><td><code>{@link #SplitPairRule_splitRatio com.example.tut:splitRatio}</code></td><td></td></tr>
     * </table>
     ...
     * "<code>false</code>".
     *
     * @attr name com.example.tut:clearTop
     */
     ...
     * "<code>false</code>".
     *
     * @attr name com.example.tut:finishPrimaryWithSecondary
     */
     ...
     * "<code>false</code>".
     *
     * @attr name com.example.tut:finishSecondaryWithPrimary
     */
    public static final int SplitPairRule_finishSecondaryWithPrimary=2;
    /**
     * <p>This symbol is the offset where the {@link com.example.tut.R.attr#splitLayoutDirection}
     ...
     * </table>
     *
     * @attr name com.example.tut:splitLayoutDirection
     */
    public static final int SplitPairRule_splitLayoutDirection=3;
    /**
     * <p>This symbol is the offset where the {@link com.example.tut.R.attr#splitMinSmallestWidth}
     * attribute's value can be found in the {@link #SplitPairRule} array.
     *
     * <p>May be a dimension value, which is a floating point number appended with a
     * unit such as "<code>14.5sp</code>".
     ...
     * mm (millimeters).
     *
     * @attr name com.example.tut:splitMinSmallestWidth
     */
    public static final int SplitPairRule_splitMinSmallestWidth=4;
    /**
     * <p>This symbol is the offset where the {@link com.example.tut.R.attr#splitMinWidth}
     * attribute's value can be found in the {@link #SplitPairRule} array.
     *
     * <p>May be a dimension value, which is a floating point number appended with a
     * unit such as "<code>14.5sp</code>".
     ...
     * mm (millimeters).
     *
     * @attr name com.example.tut:splitMinWidth
     */
    public static final int SplitPairRule_splitMinWidth=5;
    /**
     * <p>This symbol is the offset where the {@link com.example.tut.R.attr#splitRatio}
     * attribute's value can be found in the {@link #SplitPairRule} array.
     *
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name com.example.tut:splitRatio
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #SplitPlaceholderRule_placeholderActivityName com.example.tut:placeholderActivityName}</code></td><td>Component name of the placeholder activity in the split.</td></tr>
     * <tr><td><code>{@link #SplitPlaceholderRule_splitLayoutDirection com.example.tut:splitLayoutDirection}</code></td><td></td></tr>
     * <tr><td><code>{@link #SplitPlaceholderRule_splitMinSmallestWidth com.example.tut:splitMinSmallestWidth}</code></td><td></td></tr>
     * <tr><td><code>{@link #SplitPlaceholderRule_splitMinWidth com.example.tut:splitMinWidth}</code></td><td></td></tr>
     * <tr><td><code>{@link #SplitPlaceholderRule_splitRatio com.example.tut:splitRatio}</code></td><td></td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name com.example.tut:placeholderActivityName
     */
